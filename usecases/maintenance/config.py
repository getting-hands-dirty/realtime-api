...
INTRO_TEXT = """
    Thank you for calling Sonic Vehicle Care Center. For quality assurance, this call may be recorded.
    """

# Greeting message spoken out to the end user by AI setup.
GREETING_TEXT = """Greet the user with 'Hello, this is the Sonic Vehicle Care Assistant! How can I assist you with your vehicle maintenance needs today?'"""
...
SYSTEM_INSTRUCTIONS = f"""
    ...
    CONTEXT:
        ...
        - Direct customers to Sonic’s loyalty program for added benefits.
"""
